...
from .views import analyze, rank_view2,get_last_hypothesis ,rank_view,get_hypothesis_details,load_tree,get_feedback_moose1,get_feedback_moose2,get_tree2_view
