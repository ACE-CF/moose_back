...
if __name__ == "__main__":
    ...
    parser.add_argument("--api_key", type=str, default="sk-nD59p1EN85wAVXv9AMQCWbib1LOlJ35aIwun5e7JJ3rSJHlA")
    parser.add_argument("--base_url", type=str, default="http://35.220.164.252:3888/v1/", help="base url for the API")
